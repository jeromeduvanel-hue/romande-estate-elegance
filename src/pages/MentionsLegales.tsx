...
const MentionsLegales = () => {
  return (
    <main className="min-h-screen bg-background text-foreground">
      <SEOHead
        title="Mentions légales | Trois Dimensions SA"
        description="Mentions légales du site Trois Dimensions SA, promoteur immobilier à Bulle, Suisse."
        canonical="https://trois-dimensions.ch/mentions-legales"
      />
